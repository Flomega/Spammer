...
# This function can allow user send messages with counting
def message_with_counting():
    print(Fore.LIGHTMAGENTA_EX + "\n[*] Message with counting" + Style.RESET_ALL + Fore.RED + "\t<SELECTED>" + Style.RESET_ALL)
    # Set how many times user want to send a messages
...
# Tool name designe
name_of_tool = pyfiglet.figlet_format("Spammer")
...
print(Fore.GREEN + Style.BRIGHT + 'Flomega303'+ Style.RESET_ALL)
